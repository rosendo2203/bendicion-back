...
import com.tienda.bendicion.repository.ProductoRepository;
...
public class ProductoController {
	...
	public ResponseEntity<Producto> updateProductos(@PathVariable("codigoproducto") Integer codigoproducto,
